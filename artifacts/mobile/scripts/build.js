...
function getExpoPublicProjectId() {
  return process.env.EXPO_PUBLIC_PROJECT_ID;
}

async function startMetro(expoPublicDomain, expoPublicProjectId) {
  ...
  const env = {
    ...
    EXPO_PUBLIC_PROJECT_ID: expoPublicProjectId,
  };

  if (expoPublicProjectId) {
    console.log(`Setting EXPO_PUBLIC_PROJECT_ID=${expoPublicProjectId}`);
  }
...
async function main() {
  ...
  const expoPublicProjectId = getExpoPublicProjectId();
  ...
  await startMetro(domain, expoPublicProjectId);
